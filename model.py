...
#         out_real1, out_imag1, conv_real1, conv_imag1 = cov_encoder_module(real_stft, imag_stft, 32, (7, 1), (1, 1), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real2, conv_imag2 = cov_encoder_module(out_real1, out_imag1, 32, (1, 7), (1, 1), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real3, conv_imag3 = cov_encoder_module(out_real1, out_imag1, 64, (7, 5), (2, 2), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real4, conv_imag4 = cov_encoder_module(out_real1, out_imag1, 64, (7, 5), (2, 1), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real5, conv_imag5 = cov_encoder_module(out_real1, out_imag1, 64, (5, 3), (2, 2), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real6, conv_imag6 = cov_encoder_module(out_real1, out_imag1, 64, (5, 3), (2, 1), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real7, conv_imag7 = cov_encoder_module(out_real1, out_imag1, 64, (5, 3), (2, 2), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real8, conv_imag8 = cov_encoder_module(out_real1, out_imag1, 64, (5, 3), (2, 1), training = self.norm_trainig)
#         out_real1, out_imag1, conv_real9, conv_imag9 = cov_encoder_module(out_real1, out_imag1, 64, (5, 3), (2, 2), training = self.norm_trainig)
#         out_real1, out_imag1, _, _ = cov_encoder_module(out_real1, out_imag1, 90, (5, 3), (2, 1), training = self.norm_trainig)
#         center_real1, center_imag1 = cov_center_module(out_real1, out_imag1, 64, (5, 3), (2, 1), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(center_real1, center_imag1, conv_real9, conv_imag9, 64, (5, 3), (2, 2), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real8, conv_imag8, 64, (5, 3), (2, 1), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real7, conv_imag7, 64, (5, 3), (2, 2), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real6, conv_imag6, 64, (5, 3), (2, 1), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real5, conv_imag5, 64, (5, 3), (2, 2), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real4, conv_imag4, 64, (7, 5), (2, 1), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real3, conv_imag3, 32, (7, 5), (2, 2), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real2, conv_imag2, 32, (1, 7), (1, 1), training = self.norm_trainig)
#         deconv_real1, deconv_imag1 = cov_decoder_module(deconv_real1, deconv_imag1, conv_real1, conv_imag1, 1, (7, 1), (1, 1), training = self.norm_trainig)
