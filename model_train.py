...
if __name__ == "__main__":
      ...
      parser.add_argument("--trn",   type = str, default = "./datasets/train_nosiy/", help = "Input train noisy path")
      ...
      parser.add_argument("--save",  type = str, default = "dcunet20_save",            help = "Input save file name")
